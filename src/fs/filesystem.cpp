                       ...
                       uint64_t countNode, NodeHash hashLocalNode)
{
    if ((buffer == NULL) || (bufferBlock == NULL) || (countFile == 0) || (countDirectory == 0) ||
        ...
        // xxxx
        Debug::notifyInfo("buffer: %d, bufferBlock: %d, countFile: %d, countDirectory: %d, countBlock: %d, countNode: %d, hashLocalNode: %d, \
                           hashLocalNode > countNode: %d", buffer, bufferBlock, countFile, countDirectory, countBlock, countNode,
                           hashLocalNode, hashLocalNode > countNode);
        // xxxx
